...
class ModelExtensionPaymentFreedompay extends Model
{
    public function getMethod($address)
    {
        ...
        if ($status) {
            $method_data = array(
                'code'       => 'freedompay',
                'title'      => !$this->config->get('payment_freedompay_payment_name') ? $this->language->get(
                    'text_title'
                ) : $this->config->get('payment_freedompay_payment_name'),
                'terms'      => '',
                'sort_order' => $this->config->get('payment_freedompay_sort_order')
            );
        }
